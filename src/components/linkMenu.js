            ...
            userTools =
                [
                    ...
                    <SubMenu key="/exhibits" title={<span><TeamOutlined/><span>Exhibit Hall</span></span>}>
                        ...
                        <Menu.Item key='/exhibits/posters/icse-2020/poster' icon={<BorderOutlined/>}><NavLink to="/exhibits/posters/icse-2020-poster">Posters</NavLink></Menu.Item>
                        <Menu.Item key='/exhibits/posters/src-posters' icon={<BorderOutlined/>}><NavLink to="/exhibits/posters/icse-2020-ACM-Student-Research-Competition">SRC Posters</NavLink></Menu.Item>
                    </SubMenu>,
