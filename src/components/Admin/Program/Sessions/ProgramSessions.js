    ...
    render() {
        const columns = [
            ...
            },
            {
                title: 'Start Time',
                dataIndex: 'start',
                render: (text,record) => <span>{moment(record.get("startTime")).format("YYYY-MM-DD HH:mm (Z)")}</span>,
                key: 'start',
            },
            {
                title: 'End Time',
                dataIndex: 'end',
                render: (text,record) => <span>{moment(record.get("endTime")).format("YYYY-MM-DD HH:mm (Z)")}</span>,
                key: 'end',
            },
            {
                title: 'Room',
